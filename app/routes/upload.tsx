    ...
    const handleAnalyze = async ({
        ...
        try {
            ...
            if (typeof feedback.message?.content === "string") {
                ...
                setStatusText("Error: Unexpected feedback format");
                return;
            }
            ...
            try {
                ...
                console.error("❌ Failed to parse feedback JSON:", feedbackText, parseErr);
            ...
            setStatusText(`Unexpected error: ${err.message || "See console"}`);
        } finally {
